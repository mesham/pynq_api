...
* [Userspace IO (UIO)](#userspace-io-uio)
...
`int PYNQ_PYNQ_loadPartialBitstream(char* filename)`

Similar to the previous call, but used for loading partial bitstreams onto the PL.
